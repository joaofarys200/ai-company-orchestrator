...
|---|---|---|---:|---|---|
| `D01_BASELINE_SIMPLE` | direct_ollama | SUCCEEDED | 19978.992 | True | True |
| `D02_STATEFUL_PROMPT_NO_SCHEMA` | direct_ollama | SUCCEEDED | 25882.976 | True | True |
| `D03_STATEFUL_PROMPT_MINIMAL_SCHEMA` | direct_ollama | SUCCEEDED | 17590.753 | True | True |
| `D04_FULL_SCHEMA_NO_TOOLS` | direct_ollama | SUCCEEDED | 22443.099 | True | True |
| `D05_FULL_SCHEMA_ONE_TOOL` | direct_ollama | SUCCEEDED | 19298.714 | True | True |
| `D06_FULL_SCHEMA_ALL_TOOLS` | direct_ollama | SUCCEEDED | 19571.416 | True | True |
| `D07_DIRECT_OLLAMA_FULL_REQUEST` | direct_ollama | SUCCEEDED | 21207.038 | True | True |
| `D08_HARNESS_FULL_REQUEST` | ModelHarness.execute -> OllamaBenchmarkProvider | SUCCEEDED | 19827.605 | False | False |
...
- `H7_OLLAMA_RUNTIME`: **NOT_SUPPORTED**; evidence hash `f9b4842f81a852628491fe5d13f1efa4e98ba262b97bbbbe6d1b38d4f3cfe0cd`.
