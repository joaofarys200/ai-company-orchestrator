...
- Explicitly approved model unloads isolated matrix variants; all 14 unload operations succeeded.
...
- Validation record: `{"focal_pytest": {"duration_seconds": 0.83, "passed": 35, "status": "PASSED"}, "full_pytest": {"duration_seconds": 133.29, "passed": 529, "skipped": 1, "status": "PASSED", "warnings": 14}, "full_stateful_smoke_rerun": false, "import_server": {"output": "IMPORT_SERVER_OK", "status": "PASSED"}, "py_compile": {"status": "PASSED"}}`.
