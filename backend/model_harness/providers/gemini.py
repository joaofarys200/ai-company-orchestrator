...
class GeminiOpenAIProvider:
    """Google Gemini transport behind the shared ModelHarness boundary."""
    ...
    def _provider_result(envelope: Mapping[str, Any]) -> ProviderResult:
        ...
        input_tokens = GeminiOpenAIProvider._optional_int(
            usage.get("prompt_tokens")
        )
        output_tokens = GeminiOpenAIProvider._optional_int(
            usage.get("completion_tokens")
        )
        total_tokens = GeminiOpenAIProvider._optional_int(
